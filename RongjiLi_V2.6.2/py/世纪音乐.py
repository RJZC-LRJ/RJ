...
class Spider(Spider):
        ...
        try:
            ...
            for li in doc("#datalist li, .lkmusic_list li, .layui-row.lkbj li").items():
                ...
                if not pic:
                    pic = li("img").attr("src")
                if not pic:
                    pic = "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg"
            ...
            for li in doc(".ilingkuplay_list li, .play_list li, .song_list li").items():
                ...
                if vod_id not in seen_ids:
                    ...
                    self.home_recommend_cache.append({
                        ...
                        "vod_pic": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                        "vod_remarks": "✨ 新歌推荐",
                        "song_id": song_id,
                        "singer": "",
                        "name": name,
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        if tid == "home":
            ...
            # 网易云音乐排行榜封面图片映射
            rank_pics = {
                "rise": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "new": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "original": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "top": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "douyin": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "kuaishou": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "zwdj": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "hot": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "japan": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "oumei": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "korea": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "america": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "acg": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "acgyx": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "acgdm": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "omtop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "dian": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "uktop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "gudian": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "raptop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "dytop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "qianli": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "yytop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "ystop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "xyztop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "djtop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "ktvtop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "chetop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "aytop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
                "sqtop": "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg"
            }
            ...
            for rank in page_items:
                pic = rank_pics.get(rank['id'], "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg")
                items.append({
            ...
            for li in doc(".video_list li, .play_list li, .ilingku_list li").items():
                ...
                mv_item = {
                    "vod_id": self._abs(href),
                    "vod_name": name,
                    "vod_pic": self._get_image(pic, is_mv=True) if pic else "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg",
    ...
    def _get_rank_detail(self, rank_type, url):
        ...
        rank_pic = rank_pics.get(rank_type, "https://gitee.com/UserRJZC/rjgitee/raw/Admin/icon/R.jpg")
